/**
 * Basic data aggregation utilities
 */
import { formatNumber } from '../utils/formatting.js';

/**
 * Aggregate commits by contributor (basic grouping)
 * @param {Array} commits - Array of commit objects
 * @param {string} groupBy - 'name' or 'email'
...
/**
 * Compute metadata from contributors array
...
/**
 * Print contributors table to console
 * @param {Array} contributors
 * @param {object} meta
...
/**
 * Print contributors as CSV to console
 * @param {Array} contributors
 * @param {string} groupBy
 */
